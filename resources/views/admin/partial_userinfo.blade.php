                                        ...
                                        <div class="col-lg-offset-1 col-md-offset-1 col-lg-10 col-md-10">
                                            <form class="form-horizontal style-form" id="form-userinfo" action="">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input class="form-control" name="idcardnumber" value="{{ __($user->identity)}}" type="text" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label" for="">{{ __("Phone Number") }}</label>
                                                    <div class="col-sm-9">
                                                        <input class="form-control" name="phonenumber" value="{{ __($user->phone)}}" type="text" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label" for="">{{ __("Alipay ID") }}</label>
                                                    <div class="col-sm-9">
                                                        <input class="form-control" name="alipayid" value="{{ __($user->pay_email ? $user->pay_email : $user->pay_phone)}}" type="text" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label" for="">{{ __("Credit Level") }}</label>
                                                    <div class="col-sm-9">
                                                        <input class="form-control" name="creditlevel" value="{{ __($user->data->credit)}}" type="text" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label" for="">{{ __("Activity Coin") }}</label>
                                                    <div class="col-sm-9">
                                                        <input class="form-control" name="activitycoin" value="{{ __($user->data->activity_coin)}}" type="text" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label" for="">{{ __("Original Coin") }}</label>
                                                    <div class="col-sm-9">
                                                        <input class="form-control" name="originalcoin" value="{{ __($user->data->original_coin)}}" type="text" disabled>
                                                    </div>
                                                </div>
                                                <div class="form-group">
