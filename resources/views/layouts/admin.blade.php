  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="{{ route('login.admin') }}" class="logo"><b>{{ config('app.name', 'TSWVC') }}</b></a>
            <!--logo end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a data-path="general" href="#">{{ __('General') }}</a></li>
                          <li><a data-path="buttons" href="#">{{ __('Buttons') }}</a></li>
...
-->
    ...
    <script type="text/javascript" src="https://cdn.bootcss.com/jquery.customSelect/0.5.1/jquery.customSelect.min.js"></script>

    <script type="text/javascript" src="js/partial_loader.js"></script>
